...
O roteiro de experimento do limarka encontravá-se disponibilizado on-line através do Wiki do projeto. A seguir é apresentado uma versão impressa do roteiro que também foi utilizada com alguns usuários.

\includepdf[pages=-]{imagens/roteiro-experimento.pdf}

# Roteiro das entrevistas do experimento do limarka {#experimento:entrevista}

As entrevistas com os voluntários foram semiestruturadas, uma lista de tópicos (ver Figura \ref{fig:entrevista-experimento-topicos}) era utilizada para guiar as entrevistas, que eram conduzidas no formato de conversas. As entrevistas estão disponíveis em \cite{limarka_entrevitas}.
...
Nesta seção é apresentado o roteiro das entrevistas realizadas com usuários reais do limarka, durante a produção de seus TCCs. As perguntas foram dividias em três seções.
...
* Você sabe o que as normas da ABNT *fala* sobre os seguntes itens?
...
- O que você achou de utilizar Markdown para escrita de um TCC?
